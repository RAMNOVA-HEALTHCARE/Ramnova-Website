...
export default function AboutUs() {
  ...
  const backgroundImageLink = imageMap["who.jpg"];
  ...
  return (
    <>
      <Jumbotron
        ...
        heading="WHO ARE "
        heightlighterHeading={<span style={{ color: '#E88D67' }}>WE ?</span>}
      ...
      />
      <Typography variant="h4" color="black" textAlign="center" margin="1em" sx={{ textDecoration: 'underline' }}>
        About Us
      </Typography>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '2em 0', maxWidth: '100%', margin: 'auto', borderRadius: '30px' }}>
        <TextCarousal />
        <div style={{ flex: '1', marginLeft: '2em', textAlign: 'left', padding: '0 3em' }}>
          <h2 style={{ fontFamily: '"Mundo Serif Medium", serif', fontSize: '2.5em', marginBottom: '1em' }}>
            Dedicated to Quality and Care
          </h2>
          <p style={{ fontFamily: 'Arial, sans-serif', fontSize: '16px', lineHeight: '1.6', color: '#333' }}>
          ...
          <p style={{ fontFamily: 'Arial, sans-serif', fontSize: '14px', lineHeight: '1.6', color: '#666' }}>
      ...
      {cardDatalocal.map((cardData, index) => (
        <MajorDisplayCard
          ...
          index={index}
          cardtheme="light"
          imgL={imageMap[cardData.contentImageKey]}
